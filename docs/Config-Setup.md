...
| `tag_tracker_error_ignore_urls`     | List of tracker announce URLs (or base hosts) that should be ignored by `--tag-tracker-error`. Matching trackers will not be tagged.                                                                                                                                                                                                           |                           | <center>❌</center> |
